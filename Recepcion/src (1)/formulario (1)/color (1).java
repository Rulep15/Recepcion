            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tx_color, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
...
{
     this.tx_color.setEnabled(true);
     
     //habilta los demas text si hay
      this.tx_color.requestFocus();
}
private void des_text()
{
     this.tx_color.setEnabled(false);
 ...
 private void generar_id()
   {     
        ...
        try 
        {
            ...
            miconex.resultado = miconex.sentencia.executeQuery("SELECT IFNULL(MAX(col_id),0) + 1  AS nuevo FROM color");
  ...
  private void grabar()
   {    
       if(operacion.equals("agregar"))      
        try {
            miconex.sentencia = miconex.conexion.createStatement();
            miconex.sentencia.executeUpdate("INSERT INTO color(col_id,col_descri) VALUES("+this.tx_codigo.getText()+",'"+this.tx_color.getText()+"')");
           ...
           try 
            {
                ...
                miconex.sentencia.executeUpdate("UPDATE color SET col_descri = '"+this.tx_color.getText()+"' WHERE col_id ="+this.tx_codigo.getText());
    ...
    { 
        try {
            ...
            miconex.sentencia = miconex.conexion.createStatement();
            miconex.resultado = miconex.sentencia.executeQuery("SELECT * FROM color WHERE col_id ="+this.tx_codigo.getText());
            ...
            if(encontro==true)
            {
                ...
                {    
                    ...
                    if(respuesta == JOptionPane.YES_OPTION)
                    {
                        //borrar
                        miconex.sentencia = miconex.conexion.createStatement();
                        miconex.sentencia.executeUpdate("DELETE FROM color WHERE col_id ="+this.tx_codigo.getText());
     ...
     private void cargar_grilla()
   {
       ...
       try 
        {
          miconex.sentencia = miconex.conexion.createStatement();
          miconex.resultado = miconex.sentencia.executeQuery("SELECT * FROM color");
           //boolean encontro = false;
           ...
           while(miconex.resultado.next()==true)
            {
               //tirar a la grilla 
               Object registro[] = new Object[] {miconex.resultado.getString("col_id"),miconex.resultado.getString("col_descri")};
